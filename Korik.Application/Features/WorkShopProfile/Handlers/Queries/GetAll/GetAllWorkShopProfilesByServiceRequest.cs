...
{
    public record GetAllWorkShopProfilesByServiceRequest(GetAllWorkShopProfilesByServiceDTO Model) : IRequest<ServiceResult<PagedResult<WorkShopProfileDTO>>>
    {
    }

    public class GetAllWorkShopProfilesByServiceRequestHandler : IRequestHandler<GetAllWorkShopProfilesByServiceRequest, ServiceResult<PagedResult<WorkShopProfileDTO>>>
    {
        #region Dependency Injection

        private readonly IWorkShopProfileService _workShopProfileService;
        private readonly IMapper _mapper;
        private readonly IValidator<GetAllWorkShopProfilesByServiceDTO> _validator;

        public GetAllWorkShopProfilesByServiceRequestHandler(
            IWorkShopProfileService workShopProfileService,
            IMapper mapper,
            IValidator<GetAllWorkShopProfilesByServiceDTO> validator
            )
        {
        ...
        public async Task<ServiceResult<PagedResult<WorkShopProfileDTO>>> Handle(GetAllWorkShopProfilesByServiceRequest request, CancellationToken cancellationToken)
        {
            #region Not Valid
