...
{
    public record GetAllUnverifiedWorkShopProfileRequest(PagedRequestDTO Model) : IRequest<ServiceResult<PagedResult<WorkShopProfileDTO>>> { }

    public class GetAllUnverifiedWorkShopProfileRequestHandler : IRequestHandler<GetAllUnverifiedWorkShopProfileRequest, ServiceResult<PagedResult<WorkShopProfileDTO>>>
    {
        ...
        public GetAllUnverifiedWorkShopProfileRequestHandler(
        ...
        public async Task<ServiceResult<PagedResult<WorkShopProfileDTO>>> Handle(GetAllUnverifiedWorkShopProfileRequest request, CancellationToken cancellationToken)
        {
            #region Not Valid
            ...
            var result = await _workShopProfileService.GetAllPagedAsync
               ...
               request.Model.PageNumber,
                request.Model.PageSize,
                   x => x.VerificationStatus == VerificationStatus.Pending || x.VerificationStatus == VerificationStatus.Rejected
                );
